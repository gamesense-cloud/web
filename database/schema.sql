-- gamesense.cloud dashboard — full schema.
-- This file is the canonical shape of the database. The files in
-- database/migrations/ apply it in order; this is what they add up to.
-- SQLite dialect.
